<div class="custom-title-meta" style="display: flex; gap: 2rem; margin: 1rem 0 1.5rem 0; font-size: 0.875em; color: #6c757d;">
  <div>
    <div style="font-weight: 600; margin-bottom: 0.25rem;">AUTHOR</div>
    <div>Nikolaj Maack Bielefeld</div>
  </div>
  <div>
    <div style="font-weight: 600; margin-bottom: 0.25rem;">LAST UPDATED</div>
    <div>`j using Dates; Dates.format(today(), "U d, yyyy")`</div>
  </div>
</div>
