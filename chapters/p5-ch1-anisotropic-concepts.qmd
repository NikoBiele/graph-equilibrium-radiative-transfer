...
$$
\mathbf{B}_{\mathrm{init},ij} = \mathbf{\Gamma}_{ij} \cdot (1 - \mathbf{P}_{jj})
$$ {#eq-b-init}
...
$$
\mathbf{s}_i = \sum_j \mathbf{U}_{ij} = \sum_j (K_{\mathrm{init},ij} + \mathbf{F}_{ij} \cdot \mathbf{P}_{jj})
$$ {#eq-row-sums}
...
$$
K_{ij} = \mathbf{T}_{ij} - \mathbf{F}_{ij} \cdot \mathbf{P}_{jj}
$$ {#eq-k-final}

Substituting from @eq-normalize:

$$
K_{ij} = \frac{K_{\mathrm{init},ij} + \mathbf{F}_{ij} \cdot \mathbf{P}_{jj}}{\mathbf{s}_i} - \mathbf{F}_{ij} \cdot \mathbf{P}_{jj}
$$ {#eq-k-explicit}

Simplifying:

$$
K_{ij} = \frac{K_{\mathrm{init},ij}}{\mathbf{s}_i} - \mathbf{F}_{ij} \cdot \mathbf{P}_{jj} \left(1 - \frac{1}{\mathbf{s}_i}\right)
$$ {#eq-k-simplified}
