...
Therefore, for general geometries, to determine the equilibrium state, all possible ray trajectories must be solved simultaneously.
...
The RTE is concerned with radiative transfer in participating media and does not directly account for surface reflections.
The exchange factor transformation of the GERT framework includes surface treatment and may be thought of as a generalized hybrid numerical-analytical solution of the RTE.
The numerical part of the solution is necessary to obtain exchange factors which are required in the GERT framework.

## Matrix-based Methods for Radiative Transfer
