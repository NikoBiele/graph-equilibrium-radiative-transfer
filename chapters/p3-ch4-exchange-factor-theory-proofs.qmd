...
::: {.theorem data-title="Spectral Radius of Absorption" #theorem-spectral_radius_absorption}
...
From Theorem @theorem-spectral_radius_unity, it is known that $(\mathbf{A}+\mathbf{R})(\mathbf{1} - \mathbf{b}) = (\mathbf{1} - \mathbf{b})$ with $\rho(\mathbf{A}+\mathbf{R}) = 1$.
Therefore:
$$
\begin{aligned}
...
::: {.theorem data-title"Upper Bound on Spectral Radius of Reflection-Scattering" #theorem-reflection_upper_bound}
...
::: {.theorem data-title="Spectral Radius of Reflection-Scattering for Uniform Properties" #theorem-uniform_beta}
...
The upper bound from Theorem @theorem-reflection_upper_bound gives:
...
::: {.theorem data-title="Spectral Radius Sum Property" #theorem-spectral_sum}
...
From Theorems @theorem-spectral_radius_absorption and @theorem-uniform_beta:
